...
>
> 學生：王語揚、呂筱婕、林峻霆 ｜ 指導教授：李良一、吳清麟 ｜ 國立臺灣師範大學 ｜ 2025

> **注意**：本文件由 `thesis.docx` 自動轉換生成，部分格式可能與原檔略有出入。
> 如需完整格式版本，請下載 [`thesis.docx`](thesis.docx)。
...
令 [![圖 1](figures/figure_01.png)](https://www.codecogs.com/eqnedit.php?latex=N_%7Bpos%7D%2C%20N_%7Bneg%7D%2C%20N_%7Bneu%7D#0) 分別為當日正面、負面、中性留言數，總留言數 [![圖 2](figures/figure_02.png)](https://www.codecogs.com/eqnedit.php?latex=N_%7Btotal%7D#0)。

- __正面情緒佔比：  
__[__![圖 3](figures/figure_03.png)__](https://www.codecogs.com/eqnedit.php?latex=Pos%5C_prop_t%20%3D%20%5Cfrac%7BN_%7Bpos%2Ct%7D%7D%7BN_%7Btotal%2Ct%7D%7D#0)
- __負面情緒佔比：  
__[__![圖 4](figures/figure_04.png)__](https://www.codecogs.com/eqnedit.php?latex=Neg%5C_prop_t%20%3D%20%5Cfrac%7BN_%7Bneg%2Ct%7D%7D%7BN_%7Btotal%2Ct%7D%7D#0)
- __中性情緒佔比：  
__[__![圖 5](figures/figure_05.png)__](https://www.codecogs.com/eqnedit.php?latex=Neu%5C_prop_t%20%3D%20%5Cfrac%7BN_%7Bneu%2Ct%7D%7D%7BN_%7Btotal%2Ct%7D%7D#0)
...
[![圖 6](figures/figure_06.png)](https://www.codecogs.com/eqnedit.php?latex=%5CDelta%20Pos_t%20%3D%20Pos%5C_prop_t%20-%20Pos%5C_prop_%7Bt-1%7D#0)  
此指標反映情緒的「邊際變化」，用於測試極短期波動是否具資訊含量。
- 情緒動能 \(Momentum\)：  
[![圖 7](figures/figure_07.png)](https://www.codecogs.com/eqnedit.php?latex=Momentum(k%2C%20t)%20%3D%20Pos%5C_prop_t%20-%20Pos%5C_prop_%7Bt-k%7D#0)  
此指標反映 k 日內的累積情緒位移。本研究將測試 k=2（兩日動能）對市場反轉的解釋力。

### __3\.2\.3 關注度與市場指標__

- __討論量倍數 \(Volume Ratio\)：__ [![圖 8](figures/figure_08.png)](https://www.codecogs.com/eqnedit.php?latex=Vol%5C_Ratio_t%20%3D%20%5Cfrac%7BVolume_t%7D%7BAvg(Volume_%7BP1%7D)%7D#0)
- __市場報酬 \(Return\)：__ [![圖 9](figures/figure_09.png)](https://www.codecogs.com/eqnedit.php?latex=R_t%20%3D%20%5Cln(P_t%20%2F%20P_%7Bt-1%7D)#0)
- __市場波動度 \(Volatility\)：__ [![圖 10](figures/figure_10.png)](https://www.codecogs.com/eqnedit.php?latex=%7CR_t%7C#0) \(絕對報酬\)

## __3\.3 研究流程 \(Research Process\)__

__![圖 11](figures/figure_11.png)__
...
[![圖 12](figures/figure_12.png)](https://www.codecogs.com/eqnedit.php?latex=Precision%20%3D%20%5Cfrac%7BTP%7D%7BTP%20%2B%20FP%7D%2C%20%5Cquad%20Recall%20%3D%20%5Cfrac%7BTP%7D%7BTP%20%2B%20FN%7D#0)

[![圖 13](figures/figure_13.png)](https://www.codecogs.com/eqnedit.php?latex=F1%5Ctext%7B-%7DScore%20%3D%202%20%5Ctimes%20%5Cfrac%7BPrecision%20%5Ctimes%20Recall%7D%7BPrecision%20%2B%20Recall%7D#0)
...
__3\. 混淆矩陣分析 \(Confusion Matrix\)__![圖 14](figures/figure_14.png)
...
__表 4\-1：各事件子時期之敘述性統計摘要 \(Mean __[__![圖 15](figures/figure_15.png)__](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0)__ Std\) *樣本數：各期間 N=7，總 N=21*__
...
正面佔比 \([![圖 16](figures/figure_16.png)](https://www.codecogs.com/eqnedit.php?latex=Pos#0)\)

0\.1713 \([![圖 17](figures/figure_17.png)](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0) 0\.024\)

__0\.1396 \(__[__![圖 18](figures/figure_18.png)__](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0)__ 0\.022\)__

0\.1578 \([![圖 19](figures/figure_19.png)](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0) 0\.011\)

負面佔比 \([![圖 20](figures/figure_20.png)](https://www.codecogs.com/eqnedit.php?latex=Neg#0)\)

0\.5022 \([![圖 21](figures/figure_21.png)](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0)0\.024\)

0\.4860 \([![圖 22](figures/figure_22.png)](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0) 0\.008\)

0\.4643 \([![圖 23](figures/figure_23.png)](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0) 0\.025\)

中性佔比 \([![圖 24](figures/figure_24.png)](https://www.codecogs.com/eqnedit.php?latex=Neu#0)\)

__0\.3266 \(__[__![圖 25](figures/figure_25.png)__](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0)__ 0\.044\)__

__0\.3743 \(__[__![圖 26](figures/figure_26.png)__](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0)__ 0\.022\)__

__0\.3779 \(__[__![圖 27](figures/figure_27.png)__](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0)__ 0\.020\)__

__關注度__

日均討論量 \([![圖 28](figures/figure_28.png)](https://www.codecogs.com/eqnedit.php?latex=Volume#0)\)

8,275 \([![圖 29](figures/figure_29.png)](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0) 3,175\)

__29,185 \(__[__![圖 30](figures/figure_30.png)__](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0)__ 11,042\)__

19,473 \([![圖 31](figures/figure_31.png)](https://www.codecogs.com/eqnedit.php?latex=%5Cpm#0) 9,397\)

__市場表現__

平均報酬率 \([![圖 32](figures/figure_32.png)](https://www.codecogs.com/eqnedit.php?latex=R_t#0)\)
...
*註：\* *[*![圖 33](figures/figure_33.png)*](https://www.codecogs.com/eqnedit.php?latex=p%20%3C%20.05#0)*, \*\* *[*![圖 34](figures/figure_34.png)*](https://www.codecogs.com/eqnedit.php?latex=p%20%3C%20.01#0)*。效果量 *[*![圖 35](figures/figure_35.png)*](https://www.codecogs.com/eqnedit.php?latex=%5Ceta%5E2%20%3E%200.14#0)* 視為大效果。*

結果證實了「結構性斷裂（Structural Break）」的存在。尤其是中性情緒與負面情緒的 F 值皆超過 6\.0，且效果量（[![圖 36](figures/figure_36.png)](https://www.codecogs.com/eqnedit.php?latex=%5Ceta%5E2#0)）均大於 0\.40，顯示政策事件對社群情緒結構具有極強的解釋力。
...
__顯著下降__ \([![圖 37](figures/figure_37.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.024#0)\)

[![圖 38](figures/figure_38.png)](https://www.codecogs.com/eqnedit.php?latex=t%3D2.59%2C%20d%3D1.38#0)

無顯著差異 \([![圖 39](figures/figure_39.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.135#0)\)

[![圖 40](figures/figure_40.png)](https://www.codecogs.com/eqnedit.php?latex=t%3D1.68#0)

__顯著上升__ \([![圖 41](figures/figure_41.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.030#0)\)

[![圖 42](figures/figure_42.png)](https://www.codecogs.com/eqnedit.php?latex=t%3D-2.58%2C%20d%3D-1.38#0)

__P2 \(衝擊\) vs P3 \(暫緩\)__

邊際顯著回升 \([![圖 43](figures/figure_43.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.077#0)\)

邊際顯著下降 \([![圖 44](figures/figure_44.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.060#0)\)

無顯著差異 \([![圖 45](figures/figure_45.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.754#0)\)

__P1 \(前\) vs P3 \(暫緩\)__

無顯著差異 \([![圖 46](figures/figure_46.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.215#0)\)

__顯著下降__ \([![圖 47](figures/figure_47.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.013#0)\)

[![圖 48](figures/figure_48.png)](https://www.codecogs.com/eqnedit.php?latex=t%3D2.91%2C%20d%3D1.56#0)

__顯著上升__ \([![圖 49](figures/figure_49.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.021#0)\)

[![圖 50](figures/figure_50.png)](https://www.codecogs.com/eqnedit.php?latex=t%3D-2.82%2C%20d%3D-1.51#0)

__綜合分析：__

1. 衝擊當下的反應（P1 [![圖 51](figures/figure_51.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crightarrow#0) P2）：  
政策發布當下，社群最顯著的反應是「信心崩盤（Positive 下降）」與「觀望氣氛濃厚（Neutral 上升）」。統計顯示 [![圖 52](figures/figure_52.png)](https://www.codecogs.com/eqnedit.php?latex=Pos#0) 顯著下降（[![圖 53](figures/figure_53.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.024#0)），而 [![圖 54](figures/figure_54.png)](https://www.codecogs.com/eqnedit.php?latex=Neu#0) 顯著上升（[![圖 55](figures/figure_55.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.030#0)）。有趣的是，負面情緒 [![圖 56](figures/figure_56.png)](https://www.codecogs.com/eqnedit.php?latex=Neg#0) 在此階段並未顯著升高，這佐證了前述「資訊焦慮大於情緒宣洩」的論點。
2. 暫緩後的結構質變（P1 [![圖 57](figures/figure_57.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crightarrow#0) P3）：  
即使到了政策暫緩期（P3），社群情緒仍未完全回復至 P1 狀態。雖然正面情緒與 P1 無異（[![圖 58](figures/figure_58.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.215#0)），但中性情緒仍維持在高檔（[![圖 59](figures/figure_59.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.021#0)），且負面情緒顯著低於前期（[![圖 60](figures/figure_60.png)](https://www.codecogs.com/eqnedit.php?latex=p%3D.013#0)）。這暗示市場經歷衝擊後，投資人變得更加謹慎與理性，PTT 討論風氣從原本的「多空對罵（高 Neg）」轉型為「理性分析與資訊交換（高 Neu）」。
...
為觀察情緒指標與市場走勢的相對關係，本研究將每日「正面情緒佔比 \([![圖 61](figures/figure_61.png)](https://www.codecogs.com/eqnedit.php?latex=Pos%5C_prop#0)\)」、「負面情緒佔比 \([![圖 62](figures/figure_62.png)](https://www.codecogs.com/eqnedit.php?latex=Neg%5C_prop#0)\)」與「加權指數累積報酬」分別進行 Z\-score 標準化處理，並繪製趨勢對照圖。

1\. 正面情緒與市場之變動![圖 63](figures/figure_63.png)

\[圖 4\-1：正面情緒佔比與市場累積報酬之 Z\-score 走勢圖\]

2\. 負面情緒與市場之變動![圖 64](figures/figure_64.png)

\[圖 4\-2：負面情緒佔比與市場累積報酬之 Z\-score 走勢圖\]

3\. 中性情緒與市場之變動

![圖 65](figures/figure_65.png)
...
- __正面情緒 \(__[__![圖 66](figures/figure_66.png)__](https://www.codecogs.com/eqnedit.php?latex=Pos#0)__\) vs\. 累積報酬：__ [![圖 67](figures/figure_67.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%3D%200.588#0) \([![圖 68](figures/figure_68.png)](https://www.codecogs.com/eqnedit.php?latex=p%20%3D%200.035#0), 顯著\)
- __負面情緒 \(__[__![圖 69](figures/figure_69.png)__](https://www.codecogs.com/eqnedit.php?latex=Neg#0)__\) vs\. 累積報酬：__ [![圖 70](figures/figure_70.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%3D%20-0.560#0) \([![圖 71](figures/figure_71.png)](https://www.codecogs.com/eqnedit.php?latex=p%20%3D%200.046#0), 顯著\)
...
![圖 72](figures/figure_72.png)![圖 73](figures/figure_73.png)【圖 4\-4 與圖 4\-5 正負面單日情緒變化量 vs\. 報酬】
...
- ΔPos\_prop 與 Rt：ρ = \.133（不顯著）
- ΔNeg\_prop 與 Rt：ρ = \-\.329（不顯著）  
...
接著引入「兩日情緒動能（Lag\-2 Momentum）」，定義為 [![圖 74](figures/figure_74.png)](https://www.codecogs.com/eqnedit.php?latex=Pos%5C_prop_t%20-%20Pos%5C_prop_%7Bt-2%7D#0)，並進行敏感度分析（表 4\-4）。
...
- __討論量倍數 vs\. 波動度 \(__[__![圖 76](figures/figure_76.png)__](https://www.codecogs.com/eqnedit.php?latex=%7CR_t%7C#0)__\)：__ [![圖 77](figures/figure_77.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%3D%200.736#0)__ \(__[__![圖 78](figures/figure_78.png)__](https://www.codecogs.com/eqnedit.php?latex=p%20%3D%200.0041#0)__, 極顯著\)__
- __討論量變化量 vs\. 波動度：__ [![圖 79](figures/figure_79.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%3D%200.709#0) \([![圖 80](figures/figure_80.png)](https://www.codecogs.com/eqnedit.php?latex=p%20%3D%200.0150#0), 顯著\)
...
- Log Volume vs\. [![圖 82](figures/figure_82.png)](https://www.codecogs.com/eqnedit.php?latex=%7CR_t%7C#0)： [![圖 83](figures/figure_83.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%3D%200.736#0) \([![圖 84](figures/figure_84.png)](https://www.codecogs.com/eqnedit.php?latex=p%20%3D%200.004#0)\)  
...
2. __同步共動 \(H2\)：__ 社群情緒水準（Level）與市場價格走勢呈現高度同步（[![圖 85](figures/figure_85.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%5Capprox%200.59#0)），證實 PTT 情緒可視為台股的同步指標。
3. __動能反轉 \(H3\)：__ 相較於單日雜訊，「兩日情緒動能（Lag\-2）」展現了最強的解釋力（[![圖 86](figures/figure_86.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%3D%200.78#0)），揭示了市場反轉背後約 __48 小時的情緒共識形成機制__。
4. __關注度效應 \(H4\)：__ 社群討論量激增（Volume Surge）是市場波動度的高效預警指標（[![圖 87](figures/figure_87.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%3D%200.74#0)）。
...
2. __情緒水準的鏡像同步（H2 成立）：__ 社群的樂觀（Positive）與悲觀（Negative）情緒佔比，分別與市場累積報酬呈現高度的同向與反向共動（Spearman [![圖 88](figures/figure_88.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%5Capprox%200.59#0)），證實 PTT 情緒可視為市場位階的同步指標。
3. __反轉訊號的時滯效應（H3 成立）：__ 相較於充滿雜訊的單日情緒變化，「兩日情緒動能（Lag\-2 Momentum）」對市場 V 型反轉展現了極強的解釋力（[![圖 89](figures/figure_89.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%3D%200.782#0)）。這揭示了市場共識的形成約需 48 小時的發酵期。
4. __關注度即風險（H4 成立）：__ 社群討論量的激增（Volume Surge）與市場波動度（Volatility）呈現極顯著正相關（[![圖 90](figures/figure_90.png)](https://www.codecogs.com/eqnedit.php?latex=%5Crho%20%3D%200.736#0)）。
